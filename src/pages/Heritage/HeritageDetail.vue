...
const activitiesData: Record<string, any> = {
  '1': {
    ...
    gallery: [
      'https://images.unsplash.com/photo-1452421822248-d4c2b9f16dc6?w=600&h=400&fit=crop&auto=format',
      'https://images.unsplash.com/photo-1605106702734-205df224ecce?w=600&h=400&fit=crop&auto=format',
      'https://images.unsplash.com/photo-1586075016320-1d14d0c89842?w=600&h=400&fit=crop&auto=format',
  ...
  '2': {
    ...
    date: '2026-04-20',
    location: '哈密市各中小学',
    image: 'https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=800&h=450&fit=crop&auto=format',
    tags: ['教育', '推广', '青少年'],
