...
const newsData: Record<string, any> = {
  '1': {
    ...
    date: '2025-05-15',
    views: 1234,
    image: 'https://images.unsplash.com/photo-1578301978693-85fa9c0320b9?w=800&h=450&fit=crop&auto=format',
    tags: ['非遗', '传承', '保护'],
    content: [
      { type: 'text', text: '近日，哈密刺绣技艺正式入选国家级非物质文化遗产代表性项目名录，这是对哈密地区传统手工艺的重要认可。' },
      { type: 'image', src: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&h=400&fit=crop&auto=format', alt: '非遗授牌仪式' },
      { type: 'heading', text: '入选意义' },
      { type: 'text', text: '此次入选国家级非遗名录，标志着哈密刺绣技艺的保护和传承工作进入了一个新的阶段。这不仅是对传统手工艺的认可，更是对民族文化传承的重要推动。' },
      { type: 'image', src: 'https://images.unsplash.com/photo-1610701596007-11502861dcfa?w=800&h=400&fit=crop&auto=format', alt: '传统刺绣作品' },
  ...
  '2': {
    ...
    content: [
      ...
      { type: 'image', src: 'https://images.unsplash.com/photo-1578301978693-85fa9c0320b9?w=800&h=400&fit=crop&auto=format', alt: '展览现场' },
      { type: 'heading', text: '活动亮点' },
      { type: 'text', text: '本次文化节将邀请多位国家级非遗传承人现场展示精湛的刺绣技艺，同时还将举办作品展览、技艺教学等活动。' },
      { type: 'image', src: 'https://images.unsplash.com/photo-1452421822248-d4c2b9f16dc6?w=800&h=400&fit=crop&auto=format', alt: '传承人演示' },
    ],
  },
  '3': {
    id: 3,
    ...
    date: '2024-01-05',
    views: 2156,
    image: 'https://images.unsplash.com/photo-1605106702734-205df224ecce?w=800&h=450&fit=crop&auto=format',
    tags: ['政策', '非遗', '扶持'],
    content: [
      { type: 'text', text: '近日，文化和旅游部联合财政部发布《关于进一步加强非物质文化遗产保护工作的指导意见》，明确提出加大对传统刺绣、剪纸等手工艺类非遗项目的资金支持力度。' },
      { type: 'image', src: 'https://images.unsplash.com/photo-1513475382585-d06e58bcb0e0?w=800&h=400&fit=crop&auto=format', alt: '政策文件发布现场' },
      { type: 'heading', text: '政策要点' },
      { type: 'text', text: '根据新政策，国家级非遗传承人每年将获得专项补助资金，用于开展传习活动、培养接班人和举办展览展示。同时，各地将建设一批非遗工坊，为传统手工艺人提供创作和销售平台。' },
      { type: 'image', src: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&h=400&fit=crop&auto=format', alt: '非遗工坊内部环境' },
  ...
  '4': {
    ...
    content: [
      ...
      { type: 'image', src: 'https://images.unsplash.com/photo-1586075016320-1d14d0c89842?w=800&h=400&fit=crop&auto=format', alt: '春季新品展示' },
      { type: 'heading', text: '活动详情' },
      { type: 'text', text: '活动时间：2024年1月1日 - 2月29日；参与方式：商城下单自动享受折扣，满500元再送精美刺绣书签一套；特别福利：前100名下单用户可获得传承人亲笔签名证书。' },
      { type: 'image', src: 'https://images.unsplash.com/photo-1578301978693-85fa9c0320b9?w=800&h=400&fit=crop&auto=format', alt: '精美礼品赠送' },
...
onMounted(() => {
  ...
  // 加载相关新闻
  relatedNews.value = [
    { id: 2, title: '2024年哈密刺绣文化节即将开幕', date: '2024-01-10', image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=300&h=200&fit=crop&auto=format' },
    { id: 3, title: '非遗保护新政策出台', date: '2024-01-05', image: 'https://images.unsplash.com/photo-1605106702734-205df224ecce?w=300&h=200&fit=crop&auto=format' },
    { id: 4, title: '春季新品限时优惠', date: '2024-01-01', image: 'https://images.unsplash.com/photo-1610701596007-11502861dcfa?w=300&h=200&fit=crop&auto=format' },
  ]
})
