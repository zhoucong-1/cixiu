...
const newsData: Record<string, any> = {
  ...
  '2': {
    ...
    content: [
      ...
      { type: 'image', src: 'https://picsum.photos/id/48/800/400', alt: '展览现场' },
      { type: 'heading', text: '活动亮点' },
      { type: 'text', text: '本次文化节将邀请多位国家级非遗传承人现场展示精湛的刺绣技艺，同时还将举办作品展览、技艺教学等活动。' },
      { type: 'image', src: 'https://picsum.photos/id/49/800/400', alt: '传承人演示' },
    ],
  },
  '3': {
    id: 3,
  ...
  '4': {
    ...
    content: [
      ...
      { type: 'image', src: 'https://picsum.photos/id/55/800/400', alt: '春季新品展示' },
      { type: 'heading', text: '活动详情' },
      { type: 'text', text: '活动时间：2024年1月1日 - 2月29日；参与方式：商城下单自动享受折扣，满500元再送精美刺绣书签一套；特别福利：前100名下单用户可获得传承人亲笔签名证书。' },
      { type: 'image', src: 'https://picsum.photos/id/56/800/400', alt: '精美礼品赠送' },
...
onMounted(() => {
  ...
  // 加载相关新闻
  relatedNews.value = [
    { id: 2, title: '2024年哈密刺绣文化节即将开幕', date: '2024-01-10', image: 'https://picsum.photos/id/50/300/200' },
    { id: 3, title: '非遗保护新政策出台', date: '2024-01-05', image: 'https://picsum.photos/id/60/300/200' },
    { id: 4, title: '春季新品限时优惠', date: '2024-01-01', image: 'https://picsum.photos/id/70/300/200' },
  ]
})
...
const handleImageError = (e: Event) => {
  ...
  // 如果主图加载失败，使用备用图
  img.src = 'https://picsum.photos/id/57/800/450'
}
</script>
